    ...
    <div className="flex min-h-screen bg-canvas">
      ...
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-brand-700 p-12 text-white lg:flex">
        ...
        <div className="relative flex items-center gap-2.5">
          ...
          <span className="font-display text-lg font-bold">Merovio CRM</span>
        </div>
        ...
        <div className="relative">
          ...
          <p className="mt-4 max-w-md text-white/70">
            Merovio CRM unifies your leads, contacts and follow-ups — then
        ...
        <p className="relative text-xs text-white/50">
          © {new Date().getFullYear()} Merovio. All rights reserved.
        </p>
      </div>
